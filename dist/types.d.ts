...
export interface BunWebSocket<Data = any> {
    message: (ws: BunServerWebSocket<Data>, message: string | ArrayBuffer | Uint8Array) => void;
...
export interface BunWebSocketHandler<Data = any> {
    fetch: (req: Request, server: BunServer<Data>) => Response | Promise<Response | void> | void;
